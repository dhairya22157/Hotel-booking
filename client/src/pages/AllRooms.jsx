...
const AllRooms = () => {
  ...
  // State to track selected checkboxes and radio buttons
  ...
  // Function to handle price range checkbox state change
  ...
  // Function to handle radio button state change
    ...
    <div className="px-4 md:px-16 lg:px-24 xl:px-32 pt-20 flex flex-col lg:flex-row gap-8">
      ...
      <div className='bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16'>
        <div className={`flex items-center justify-between px-5 py-2.5 
          ...
          <div className='text-xs cursor-pointer flex items-center justify-between px-4 py-2 border-b border-gray-300'>
