...
const Dashboard = () => {
  ...
  return (
    <div>
      ...
      with real-time insights to ensure smooth operations'>/</Title>
          ...
          <table className='w-full'>
            <thead className='bg-gray-50'>
              <tr>
                ...
                {/* <th className='py-3 px-4 text-gray-800 font-medium'>Booking ID</th> */}
              ...
              {dashboardData.bookings.map((item, index) => (
                <tr key={index} className='border-b border-gray-200'>
                  ...
                  <td className='py-3 px-4 border-t border-gray-300 flex'>
                    <button className={`py-1 px-3 rounded-full text-sm font-medium ${item.isPaid ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'}`}>
